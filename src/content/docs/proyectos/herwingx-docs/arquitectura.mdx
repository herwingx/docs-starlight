...
description: Stack tecnológico y configuración de seguridad (OAuth).
sidebar:
  order: 3
---
...
|:-----------|:-----------|:----------|
| **Core** | [Astro](https://astro.build) v5 | Framework web estático de alto rendimiento. |
...
| **Hosting** | [GitHub Pages](https://pages.github.com) | Alojamiento gratuito y rápido para sitios estáticos. |
...
Es un script serverless simple que actúa como "puente".
- **Código**: Recibe el `code` del CMS y pide el token a GitHub.
- **Secretos**: El `CLIENT_SECRET` de GitHub está almacenado aquí. **NUNCA** debe estar en el código del frontend.
