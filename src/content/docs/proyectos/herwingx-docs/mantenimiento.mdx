...
### 🆕 Registrar un Nuevo Proyecto en el CMS

Si creas una carpeta nueva para otro proyecto (ej: `src/content/docs/proyectos/finanzas`), debes registrarla en `public/admin/config.yml` para verla en el panel:
...
```yaml
  - name: project-finanzas
    ...
    create: true
    # ... copiar el resto de campos de otra colección
```
